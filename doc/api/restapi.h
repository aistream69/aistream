...
* @apiBody {String}   [comment]       使用示例: curl -F "head={\"filesize\":0,\"userdata\":{\"text\":
*                                               \"中华人民共和国的首都是[MASK]京\",\"topk\":3}}" http://127.0.0.1:11610/file-bert
* @apiSuccessExample {json} mq输出推理结果样例:
*                          {
*                              "msg_type":     "common",
*                              "data": {
*                                  "id":   99,
*                                  "timestamp":    1660893266,
*                                  "sceneimg":     {
*                                      "url":  "http://124.222.53.156:8080/image/20220819/99/1660893266_599686.jpg"
*                                  },
*                                  "object":       [
*                                      {
*                                          "type": "bicycle",
