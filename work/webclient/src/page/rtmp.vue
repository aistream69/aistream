    ...
    <div class="fillcontain">
        ...
        <div class="table_container">
            ...
            <div class="button_add">
                <el-button size="small" type="primary" @click="addRtmp()">添加设备</el-button>
            </div>
            <el-dialog title="修改设备信息" v-model="dialogFormVisible">
              ...
              <div slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="updateRtmp">确 定</el-button>
              </div>
            </el-dialog>
        </div>
    </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            async getObjs(){
                const res = await getObjStatus({type: 'rtmp', offset: this.offset, limit: this.limit});
